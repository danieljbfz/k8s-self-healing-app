...
def health():
    ...
    **200 OK** status as long as the application process is running. However,
    ...
    # system, you would add logic here to check external dependencies, like
    # pinging the database or checking queue depth. If any check fails, you
...
def internal_error(error):
    ...
    """
    # In a real app, you would log the full traceback here before returning the
